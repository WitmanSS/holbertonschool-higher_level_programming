...
Defines the Rectangle class with width, height, area, perimeter,
...
class Rectangle:
    ...
    properties for validation, public methods for area/perimeter,
    and special methods for printing and deletion.
    """
    ...
    def __str__(self):
        ...
        # Create a list of strings, where each string is a row of '#'
        row = '#' * self.__width
