...
Defines the Rectangle class, now including a class method to easily
...
class Rectangle:
    """
    Defines a rectangle, tracks instance count, and includes methods
    for comparison and creating square instances.
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int, optional): The width and height of the new square. Defaults to 0.

        Returns:
            Rectangle: A new Rectangle instance representing a square.
        """
        # cls refers to the class (Rectangle in this case)
        # We call the constructor with size for both width and height
