...
Defines the Rectangle class, managing the count of active instances
using a public class attribute.
"""


class Rectangle:
    """
    Defines a rectangle and tracks the number of active instances.
